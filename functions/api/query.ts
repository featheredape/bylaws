...
const SECTION_SUMMARIES: Record<string, string> = {
  ...
  dpa: "OCP Development Permit Areas DPA 1-7. DPA 1 island villages form character, DPA 2 non-village commercial, DPA 3 shoreline development permits, DPA 4 lakes streams wetlands, DPA 5 community well capture zones drinking water, DPA 6 unstable slopes soil erosion, DPA 7 riparian areas fish habitat SPEA streamside protection. Impervious surface limits, buffer zones, vegetation removal tree cutting, environmental professional QEP assessment.",
};
